...
from amcat.models.authorisation import get_project_permissions
...
from amcat.models.project import get_default_guest_role
...
class ProjectForm(forms.ModelForm):
    guest_role = forms.ModelChoiceField(
        queryset=get_project_permissions().select_related("content_type").order_by("id"),
        required=False, initial=get_default_guest_role(),
        help_text="Leaving this value empty means it will not be readable at all."
    )
