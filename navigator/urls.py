...
codingjob_patterns = patterns('',
    ...
    url(r'^by-coder/self/active$' ,'navigator.views.codingjob.my_index', name='my-codingjobs'),
    url(r'^by-coder/self/all$' ,'navigator.views.codingjob.my_all', name='my-codingjobs-all'),
)
