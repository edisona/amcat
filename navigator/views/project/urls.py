...
articleset_patterns = patterns('',
    url(r'^$', projectn.ArticlesetView.as_view(), name="articleset"),
...
project_patterns = patterns('',
    ...
    url(r'^articlesets/(?P<articleset_id>[0-9]+)/', include(articleset_patterns)),
    ...
    url(r'^articlesets$', projectn.ProjectArticlesets.as_view(), name='project-articlesets'),
...
urlpatterns = patterns('',
    ...
    url(r'^add$', projectn.ProjectAdd.as_view(), name='project-add'),
